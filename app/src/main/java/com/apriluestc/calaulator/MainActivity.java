...
import com.apriluestc.algorithm.Constants;
import com.apriluestc.algorithm.ExpressionHandler;
...
//        setGodMode(isGodMode);
         ...
         menu.add("大数计算").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                BigDecimalActivity.actionStart(context);
                return true;
        ...
        menu.add("进制转换").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
                BaseConversionActivity.actionStart(context);
                return true;
        ...
        menu.add("设置").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
            @Override
            public boolean onMenuItemClick(MenuItem item) {
